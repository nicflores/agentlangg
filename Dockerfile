...
# --- Message converters -----------------------------------------------------
# Data converters use Confluent's AvroConverter pointed at Apicurio Registry's
# Confluent-compatible API endpoint (/apis/ccompat/v7). The converter has no
# idea it's talking to Apicurio rather than Confluent Schema Registry — the
# ccompat endpoint mimics the Confluent SR wire protocol.
#
# CONNECT_*_CONVERTER_SCHEMA_REGISTRY_URL must be set at deploy time, e.g.:
#   https://apicurio.your-domain.internal/apis/ccompat/v7
#
# Internal converters stay on JSON — those serialize Connect's own state
# (configs, offsets, status) into Kafka and have nothing to do with your
...
# Uncomment and set at deploy time if Apicurio is behind basic auth.
# ENV CONNECT_KEY_CONVERTER_BASIC_AUTH_CREDENTIALS_SOURCE="USER_INFO"
# ENV CONNECT_KEY_CONVERTER_BASIC_AUTH_USER_INFO=""
# ENV CONNECT_VALUE_CONVERTER_BASIC_AUTH_CREDENTIALS_SOURCE="USER_INFO"
# ENV CONNECT_VALUE_CONVERTER_BASIC_AUTH_USER_INFO=""
